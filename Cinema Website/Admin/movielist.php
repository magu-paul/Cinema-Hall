...
<div id="main">
<div id="pageHeader">Manage Movie</div>
<?php
...
<tr>
    ...
    <td><a class="buttonEdit" href="movielistedit.php?movid=<?php echo $row['mov_id'];?>">Edit</a></td>
	<td><a class="buttonDelete" href="movielist.php?movid=<?php echo $row['mov_id'];?>" onclick="confirmation();">Delete</a></td>
</tr>
